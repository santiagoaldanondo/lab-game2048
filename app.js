...
function gameStatus () {
  if (game.win()) {
    document.getElementById("game-over").classList.add("show-won");
    document.getElementsByClassName("transparency").style.backgroundColor = "rgba(255, 225, 255, 0.35)";
  } else if (game.lose()) {
    document.getElementById("game-over").classList.add("show-lost");
    document.getElementsByClassName("transparency").style.backgroundColor = "rgba(255, 225, 255, 0.35)";
  }
}
