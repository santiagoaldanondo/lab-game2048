...
Game2048.prototype._moveLeft = function () {
    ...
    this.board.forEach(function (row) {
        var newRow = row.filter(function (i) { //con esto se fi ltran los que no sean nulos.
            return i !== null;
        });
        ...
        while (merged.length < 4) { //aqui, despues de cepillarnos los null queremos meter nuevos hasta rellenar los 4 espacios
            merged.push(null);
        }
